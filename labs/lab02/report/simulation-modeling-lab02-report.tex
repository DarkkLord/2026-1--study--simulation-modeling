...
\hypersetup{
  ...
  pdfauthor={Швецов Михаил Романович},
  pdflang={ru-RU},
  hidelinks,
...
Создаём рабочий каталог и активируем проект (рис.~\ref{fig-001}).
...
\caption{\label{fig-001}Каталог и активация проекта:}

\end{figure}%

Далее устанавливаем необходимые пакеты (рис.~\ref{fig-002}).
...
\caption{\label{fig-002}Установка пакетов:}

\end{figure}%

Далее проверяем правильность установки (рис.~\ref{fig-003}).
...
\caption{\label{fig-003}Проверка - успешно:}

\end{figure}%

Далее мы смотрим какие пакеты нужно доустановить для наших скриптов и
устанавливаем их (рис.~\ref{fig-004}).
...
\caption{\label{fig-004}Установка:}

\end{figure}%

Установка дополнительного пакета для второго скрипта
(рис.~\ref{fig-005}).
...
\caption{\label{fig-005}Установка:}

\end{figure}%

Создадим и запустим первый скрипт (рис.~\ref{fig-006}).
...
\caption{\label{fig-006}Запуск первого скрипта:}

\end{figure}%

Создаём и запускаем второй скрипт (рис.~\ref{fig-007}).
...
\caption{\label{fig-007}Запуск второго скрипта:}

\end{figure}%

Загружаем пакет Literate (рис.~\ref{fig-008}).
...
\caption{\label{fig-008}Загрузка:}

\end{figure}%

Создадим литературный стиль маркдаун для первого скрипта
(рис.~\ref{fig-009}).
...
\caption{\label{fig-009}Маркдаун для первого скрипта:}

\end{figure}%

Создадим литературный стиль notebooks для первого скрипта
(рис.~\ref{fig-0010}).
...
\caption{\label{fig-0010}Notebooks для первого скрипта:}

\end{figure}%

Создадим литературный стиль маркдаун для второго скрипта
(рис.~\ref{fig-0011}).
...
\caption{\label{fig-0011}Маркдаун для второго скрипта:}

\end{figure}%

Создадим литературный стиль notebooks для второго скрипта
(рис.~\ref{fig-0012}).
...
\caption{\label{fig-0012}Notebooks для второго скрипта:}

\end{figure}%

Удостоверимся, что notebooks был создан (рис.~\ref{fig-0013}).
...
\caption{\label{fig-0013}Проверка:}

\end{figure}%

Далее мы добавили в код в литературном стиле вычисление для набора
параметров и снова создаём литературный стиль
маркдаун(рис.~\ref{fig-0014}).
...
\caption{\label{fig-0014}Создание маркдаун для скрипта с набором
параметров:}

\end{figure}%

Создадим notebooks для скрипта с набором параметров
(рис.~\ref{fig-0015}).
...
\caption{\label{fig-0015}Notebooks для скрипта с набором параметров:}

\end{figure}%

Создаём документацию в \_quarto для обоих скриптов
(рис.~\ref{fig-0016}).
...
\caption{\label{fig-0016}документация \_quarto для обоих парпметров:}

\end{figure}%

Удостоверимся, что документы созданы (рис.~\ref{fig-0017}).
...
\caption{\label{fig-0017}Проверка:}

\end{figure}%

{{< include ../project/docs/lv_ode.html>}}
{{< include ../project/docs/sir_ode.html>}} \# Выводы

В данной лабораторной работе мы создали два скрипта, преобразовали их в
литературный стиль, добавили набор параметров и создали документацию в
формате \_quarto.
